...
public class Letter : GameObject
{
    ...
    private static Rectangle GetCharacterSpacing(Character character)
    {
        return character switch
        {
            ...
            Character.a => new Rectangle(1,2,5,5),
            Character.b => new Rectangle(1,0,4,7),
            Character.c => new Rectangle(1,2,3,5),
            Character.d => new Rectangle(1,0,4,7),
            Character.e => new Rectangle(1,2,5,5),
            Character.f => new Rectangle(1,0,3,7),
            Character.g => new Rectangle(1,1,4,6),
            Character.h => new Rectangle(1,0,4,7),
            Character.i => new Rectangle(1,1,1,6),
            Character.j => new Rectangle(1,1,2,6),
            Character.k => new Rectangle(1,0,3,7),
            Character.l => new Rectangle(1,0,3,7),
            Character.m => new Rectangle(1,3, 5, 4),
            Character.n => new Rectangle(1,3, 3, 4),
            Character.o => new Rectangle(1,3,4,4),
            Character.p => new Rectangle(1,0,4,7),
            Character.q => new Rectangle(1,0,4,7),
            Character.r => new Rectangle(1,0,4,7),
            Character.s => new Rectangle(1,2,4,5),
            Character.t => new Rectangle(1,0,3,7),
            Character.u => new Rectangle(1,3,4,4),
            Character.v => new Rectangle(1,3,5,4),
            Character.w => new Rectangle(1,3, 5,4),
            Character.x => new Rectangle(1,2,5,5),
            Character.y => new Rectangle(1,2,4,5),
            Character.z => new Rectangle(1,2,5,5),
