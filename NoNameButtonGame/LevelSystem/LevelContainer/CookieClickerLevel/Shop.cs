...
public class Shop : IManageable, IInteractable
{
        ...
        string[] shopOptionsNamesSus)
    {
        ...
        _optionOne.InRectangle(this).OnX(0.15F).BySizeX(-0.5F).Apply();
        ...
        _optionTwo.InRectangle(this).OnX(0.35F).BySizeX(-0.5F).Apply();
        ...
        _optionThree.InRectangle(this).OnX(0.55F).BySizeX(-0.5F).Apply();
        ...
        _optionFour.InRectangle(this).OnX(0.85F).BySizeX(-0.5F).Apply();
    ...
    {
        _optionOne.InRectangle(this).OnX(0.15F).BySizeX(-0.5F).Apply();
        _optionTwo.InRectangle(this).OnX(0.38F).BySizeX(-0.5F).Apply();
        _optionThree.InRectangle(this).OnX(0.61F).BySizeX(-0.5F).Apply();
        _optionFour.InRectangle(this).OnX(0.85F).BySizeX(-0.5F).Apply();
        _infoDiplay.InRectangle(this).OnCenter().OnY(0.9F).BySize(-0.5F).Apply();
