...
namespace NoNameButtonGame.LevelSystem.LevelContainer
{
    class Level49 : SampleLevel
    {
        ...
        public Level49(int defaultWidth, int defaultHeight, Vector2 window, Random rand) : base(defaultWidth, defaultHeight, window, rand) {
            ...
            leftWall = new Laserwall(new Vector2(-512, -512), new Vector2(420, 1024), Globals.Content.GetTHBox("zonenew"));
            rightWall = new Laserwall(new Vector2(96, -512), new Vector2(420, 1024), Globals.Content.GetTHBox("zonenew"));
            buttomWall = new Laserwall(new Vector2(-512, 96), new Vector2(1024, 1024), Globals.Content.GetTHBox("zonenew"));

            firstBlock = new Laserwall(new Vector2(-256, 32), new Vector2(64, 64), Globals.Content.GetTHBox("zonenew"));
            secondBlock = new Laserwall(new Vector2(-32, 96), new Vector2(64, 64), Globals.Content.GetTHBox("zonenew"));
            ...
            winButton = new LockButton(new Vector2(-32, -128), new Vector2(64, 32), Globals.Content.GetTHBox("awesomebutton"), true);
