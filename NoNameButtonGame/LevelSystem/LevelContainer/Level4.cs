...
internal class Level4 : SampleLevel
{
        ...
        defaultHeight, window, random)
    {
        ...
        _infoAboutButton = new TextBuilder("This button has a timer");
        _infoAboutButton.Move(new Vector2(-_infoAboutButton.Rectangle.Width / 2F, -64));
        _infoAboutButton2 = new TextBuilder("Press the button to lower the timer and when it hits 0 you win!");
